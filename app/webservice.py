...
try:
    _pm = importlib.metadata.metadata("whisper-asr-webservice")
    _app_title = _pm["Name"].title().replace("-", " ")
    _app_desc = _pm["Summary"]
    _app_ver = _pm["Version"]
    _app_url = _pm["Home-page"]
except importlib.metadata.PackageNotFoundError:
    _app_title = "Whisper ASR Webservice"
    _app_desc = "Whisper ASR Webservice"
    _app_ver = "1.10.0"
    _app_url = "https://github.com/ahmetoner/whisper-asr-webservice"

projectMetadata = {"Name": _app_title, "Summary": _app_desc, "Version": _app_ver, "Home-page": _app_url}

app = FastAPI(
    title=_app_title,
    description=_app_desc,
    version=_app_ver,
    contact={"url": _app_url},
